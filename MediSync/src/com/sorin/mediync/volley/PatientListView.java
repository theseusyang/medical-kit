...
package com.sorin.mediync.volley;
 ...
 * 
 */
public class PatientListView extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new PicasaArrayAdapter(this, 0, mEntries,
	...
	private void loadPage() {
		...
		JsonObjectRequest myReq = new JsonObjectRequest(Method.DECLARED,
			...
			public void onResponse(JSONObject response) {
				try {
					...
					for (int i = 0; i < entries.length(); i++) {
						...
						mEntries.add(new PicasaEntry(entry.getJSONObject(
