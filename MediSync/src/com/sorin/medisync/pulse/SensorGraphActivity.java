...
public class SensorGraphActivity extends Activity {
	 ...
	 */
	private static final String DEVICE_ADDRESS = "00:12:11:21:15:01";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bt_pulse);

		// get handles to Views defined in our layout file
		mGraph = (PulseGraphView) findViewById(R.id.pulse_graph);
		mValueTV = (TextView) findViewById(R.id.pulse_value);
