...
/**
 * Please note: This code is designed to demonstrate some basic concepts for
 * loading images for display within ListViews. It is not production standard
 * because it does not handle lack of connectivity, and should support image
 * caching to further improve performance. Please refer to the accompanying
 * article for more information: http://blog.stylingandroid.com/archives/1737
 */
		...
		try {
			...
			if (conn instanceof HttpURLConnection) {
				...
				if (http.getResponseCode() == HttpURLConnection.HTTP_OK
						&& http.getContentType().startsWith("image")) {
